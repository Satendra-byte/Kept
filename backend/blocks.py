...
def confirm_blocks(promise: dict) -> list:
    ...
    return [
        ...
        {
            "type": "context",
            "elements": [{"type": "mrkdwn", "text": f"owner  *{promise['owner_name']}*      due  *{due}*"}],
        },
        {
            "type": "actions",
            "elements": [
...
if __name__ == "__main__":
    ...
    p = {"id": 7, "description": "revised deck", "owner_name": "Sachin", "due_date": "2026-07-10"}

    actions = [b for b in confirm_blocks(p) if b["type"] == "actions"][0]["elements"]
